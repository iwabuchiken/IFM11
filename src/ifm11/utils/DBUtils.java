...
//					+ "]", "Data inserted => " + "(" + columnNames[0] + " => " + values[0] + "), and others");
	 ...
	 ******************************/
	public static void 
	insert_Data_TIs__IFM10
	(Activity actv, List<TI> list) {
		///////////////////////////////////
		//
		// prep: db
		//
...
//				long res = wdb.insert(CONS.DB.tname_RefreshLog, null, val);
				...
				if (res == -1) {
					...
					// Log
					String msg_Log = "insertion => failed: " + ti.getFile_name();
					Log.e("DBUtils.java"
							+ "["
							+ Thread.currentThread().getStackTrace()[2]
									.getLineNumber() + "]", msg_Log);
...
//				return true;
				...
				msg_Log = String.format(
						Locale.JAPAN,
						"Exception: file => %s", ti.getFile_name()
						);
...
//				return false;
		...
		msg_Log = String.format(
				Locale.JAPAN,
				"insertion: success => %d / failed => %d", cnt_Success, cnt_Failed
				);
...
//		return ti_List;
	 ...
	 * change table name => to 'ifm11__2013'
		@return null => 1. No DB file<br>
						2. No such table<br>
						3. Query exception<br>
						4. Query returned null<br>
...
//		return null;
	...
	public static List<TI>
	find_All_TI
	(Activity actv, String tableName, String order) {
...
//		TI ti_tmp = null;
		...
		for (Long id : CONS.TNActv.searchedItems) {
			...
			////////////////////////////////
			ti = DBUtils.find_TI_From_DbId(actv, id.longValue());
...
//		"val",									// 4
	...
	find_TI_first
	(Activity actv,
		String target_Column, CONS.Enums.SortOrder order) {
		// TODO Auto-generated method stub
...
//		"table_name"							// 11
		...
		String order_str = target_Column + " " + order.toString();
...
//		"file_name", "file_path"				// 4,5
	...
	public static List<HistUpload> 
	find_All_HistUpload
	(Activity actv, int size, String col_Name, String sort_Type) {
//		(Activity actv, int size, String col_Name, int sort_Type) {
		// TODO Auto-generated method stub
...
//		return 0;
	...
	find_All_SearchHistories(Activity actv) {
		// TODO Auto-generated method stub
...
//			null);
	...
	public static List<SearchHistory> 
	find_All_SearchHistories(Activity actv, int limit) {
		// TODO Auto-generated method stub
