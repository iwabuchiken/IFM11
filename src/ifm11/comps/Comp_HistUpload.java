...
public class Comp_HistUpload implements Comparator<HistUpload> {
	...
	public Comp_HistUpload
	(List<HistUpload>
		ti_List, SortType sortType,
		SortOrder sortOrder) {
		
		this.list_HistUploads	= ti_List;
		...
		// Log
		String msg_Log = "Comp_HistUpload => created";
		Log.d("Comp_HistUpload.java" + "["
	...
	@Override
	public int compare(HistUpload a1, HistUpload a2) {
	...
	private int _compare_FileName(HistUpload t1, HistUpload t2) {
		// TODO Auto-generated method stub
...
//				res = (int) -(a1.getCreated_at() - a2.getCreated_at());
	...
	private int _compare_CREATED_AT(HistUpload t1, HistUpload t2) {
		// TODO Auto-generated method stub
